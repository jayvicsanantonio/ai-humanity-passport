...
describe("validateGitHubUrl", () => {
	it("should validate correct GitHub URLs", () => {
		...
		expect(validateGitHubUrl("https://github.com/owner/repo/")).toBe(true);
		expect(validateGitHubUrl("https://github.com/test-user/test-repo")).toBe(
			true,
		);
		expect(validateGitHubUrl("https://github.com/user.name/repo.name")).toBe(
			true,
		);
	});
	...
	it("should reject invalid GitHub URLs", () => {
		...
		expect(validateGitHubUrl("https://github.com/owner/repo/issues")).toBe(
			false,
		);
