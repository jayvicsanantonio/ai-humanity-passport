          ...
          <div className="space-y-10">
            ...
            <div className="space-y-8">
              <h1 className="text-4xl lg:text-5xl xl:text-6xl font-elegant font-medium bg-gradient-to-r from-slate-600 via-blue-500 to-emerald-500 dark:from-slate-200 dark:via-blue-300 dark:to-emerald-300 bg-clip-text text-transparent leading-tight">
                Humanity
                <span className="text-3xl lg:text-4xl xl:text-5xl mx-3 bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">+</span>
              ...
              <div className="flex flex-wrap gap-4">
                <div className="flex items-center gap-3 bg-white/60 dark:bg-slate-800/60 backdrop-blur-sm rounded-full px-5 py-3 border border-white/20 dark:border-slate-700/50 shadow-lg hover:shadow-xl transition-all duration-300">
                  ...
                  <span className="text-slate-600 dark:text-slate-300 font-medium">AI-Powered</span>
                </div>
                <div className="flex items-center gap-3 bg-white/60 dark:bg-slate-800/60 backdrop-blur-sm rounded-full px-5 py-3 border border-white/20 dark:border-slate-700/50 shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <div className="flex items-center gap-3 bg-white/60 dark:bg-slate-800/60 backdrop-blur-sm rounded-full px-5 py-3 border border-white/20 dark:border-slate-700/50 shadow-lg hover:shadow-xl transition-all duration-300">
                  ...
                  <span className="text-slate-600 dark:text-slate-300 font-medium">Exclusive</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <Card className="relative bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border-white/20 dark:border-slate-700/50 shadow-2xl">
              <CardHeader className="text-center space-y-4 pb-8">
                ...
                <CardDescription className="text-base text-slate-500 dark:text-slate-400 max-w-sm mx-auto">
                  Enter your GitHub repository URL to begin your exclusive analysis
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-8">
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="space-y-3">
                    <label htmlFor="repo-url" className="text-sm font-medium text-slate-600 dark:text-slate-300 uppercase tracking-wide">
                  ...
                  <div className="relative bg-gradient-to-br from-blue-50/80 to-emerald-50/80 dark:from-blue-950/30 dark:to-emerald-950/30 backdrop-blur-sm rounded-xl p-6 border border-blue-200/30 dark:border-blue-800/30">
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm text-slate-600 dark:text-slate-300">
                      <div className="flex items-start gap-3">
                        <div className="bg-gradient-to-r from-blue-400 to-purple-400 rounded-full w-6 h-6 flex items-center justify-center text-white text-xs font-medium flex-shrink-0">1</div>
                        <span>AI analyzes impact</span>
                      </div>
                      <div className="flex items-start gap-3">
                        <div className="bg-gradient-to-r from-purple-400 to-emerald-400 rounded-full w-6 h-6 flex items-center justify-center text-white text-xs font-medium flex-shrink-0">2</div>
                        <span>Evaluate contribution</span>
                      </div>
                      <div className="flex items-start gap-3">
                        <div className="bg-gradient-to-r from-emerald-400 to-blue-400 rounded-full w-6 h-6 flex items-center justify-center text-white text-xs font-medium flex-shrink-0">3</div>
                        <span>Receive badge</span>
                      </div>
                      <div className="flex items-start gap-3">
                        <div className="bg-gradient-to-r from-blue-400 to-emerald-400 rounded-full w-6 h-6 flex items-center justify-center text-white text-xs font-medium flex-shrink-0">4</div>
